...
```javascript
stdev = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dists-laplace-stdev@v0.3.0-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/stats-base-dists-laplace-stdev/actions/workflows/test.yml/badge.svg?branch=v0.3.0
[test-url]: https://github.com/stdlib-js/stats-base-dists-laplace-stdev/actions/workflows/test.yml?query=branch:v0.3.0
